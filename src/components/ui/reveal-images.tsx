...
export function RevealImageListItem({ text, images, className }: ShowImageListItemProps) {
  ...
  return (
    <div className="group relative h-fit w-fit overflow-visible py-2">
      <h1 className={cn("text-7xl font-black text-foreground transition-all duration-500 group-hover:opacity-40", className)}>
        {text}
      </h1>
